...
//	}
	...
	public void clickOnCourse() throws InterruptedException {
		assertTrue(coursepage.clickOnCourse());

	}
	@Test(testName = "Click on viewcourse",priority = 16,description = "Verify that user is able to click on popUp viewcourse or not!")
	public void popUpViewCourse() throws InterruptedException {
		assertTrue(coursepage.popUpViewCourse());
